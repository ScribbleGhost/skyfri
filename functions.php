...
function skyfri_scripts() {
	wp_enqueue_style( 'skyfri-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'skyfri-style', 'rtl', 'replace' );

	wp_enqueue_script( 'skyfri-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );

	wp_enqueue_script( 'skyfri-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), _S_VERSION, true );
